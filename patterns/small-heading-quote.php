 ...
 * Slug: enroute/small-heading-quote
 * Categories: featured
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:8vw;padding-right:var(--wp--preset--spacing--60);padding-bottom:8vw;padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:25%">
			...
			<h2 class="wp-block-heading has-base-color has-text-color has-small-font-size" style="margin-top:8px;font-style:normal;font-weight:700;text-transform:uppercase"><?php echo esc_html__( 'What People Say', 'enroute' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="flex-basis:75%"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic","fontWeight":"400"}},"fontSize":"xx-large"} -->
			<p class="has-xx-large-font-size" style="font-style:italic;font-weight:400"><?php echo esc_html__( '&ldquo;We booked our honeymoon with Enroute, and it was simply incredible. They took care of everything, even our packing list. Thank you!&rdquo;', 'enroute' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"fontSize":"small"} -->
			<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--40)"><?php echo esc_html__( '— William & Megan James', 'enroute' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
