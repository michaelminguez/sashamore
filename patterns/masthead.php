...
<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-bottom">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:72%">
			...
			<h1 class="wp-block-heading alignwide has-raleway-font-family has-huge-font-size" style="font-style:normal;font-weight:900;line-height:0.8;text-transform:uppercase"><?php echo wp_kses_post( __( 'Your<br>journey<br>begins', 'enroute' ) ); ?></h1>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:28%">
			...
			<p class="has-text-align-right has-link-color has-large-font-size" style="font-style:italic;font-weight:400"><a href="#"><?php echo esc_html__( 'Explore Our Offers', 'enroute' ); ?></a>→
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
