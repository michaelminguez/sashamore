...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:8vw;padding-right:var(--wp--preset--spacing--60);padding-bottom:8vw;padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:70%">
			...
			<p class="has-raleway-font-family has-x-small-font-size" style="line-height:1.5"><?php echo wp_kses_post( __( '3 Cottage Rd, Exford,<br>Minehead SA12 7TG', 'enroute' ) ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"},"spacing":{"margin":{"top":"0"}}},"fontSize":"x-small","fontFamily":"raleway"} -->
			<p class="has-raleway-font-family has-x-small-font-size" style="margin-top:0;line-height:1.5"><?php echo esc_html_x( '01234567890', 'tel number', 'enroute' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column" style="flex-basis:15%">
			...
			<p class="has-link-color has-raleway-font-family has-x-small-font-size" style="line-height:1.5"><?php
					...
					$wordpress_link = '<a href="' . esc_url( __( 'https://wordpress.org', 'enroute' ) ) . '" rel="nofollow">WordPress</a>';
					echo sprintf(
						esc_html__( 'Designed with %1$s', 'enroute' ),
						$wordpress_link
					);?></p>
			<!-- /wp:paragraph -->
		</div>
