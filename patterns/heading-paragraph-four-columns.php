 ...
 * Slug: enroute/heading-paragraph-four-columns
 * Categories: featured
 */
?>
...
<div class="wp-block-group alignfull has-secondary-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:8vw;padding-right:var(--wp--preset--spacing--60);padding-bottom:8vw;padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-text-align-left has-xxx-large-font-size" style="font-style:normal;font-weight:900;line-height:0.9;text-transform:uppercase"><?php echo wp_kses_post( __( 'Upcoming<br>Tours', 'enroute' ) ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
		<p style="margin-top:var(--wp--preset--spacing--40)"><?php echo esc_html__( 'Embark on a journey of discovery with us, where every destination is a new door to a diverse world of people, cultures, traditions, and landscapes.', 'enroute' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:heading {"level":3} -->
				<h3 class="wp-block-heading"><?php echo esc_html__( 'Muscat', 'enroute' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Thu 25 Sep  – Tue, 30 Sep', 'enroute' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<p class="has-link-color has-small-font-size" style="font-style:italic;font-weight:400"><a href="#"><?php echo esc_html__( 'Full Details', 'enroute' ); ?></a>→</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:heading {"level":3} -->
				<h3 class="wp-block-heading"><?php echo esc_html__( 'The French Riviera', 'enroute' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Thu 25 June  – Tue, 30 June', 'enroute' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:heading {"level":3} -->
				<h3 class="wp-block-heading"><?php echo esc_html__( 'Noordhoek Beach', 'enroute' ); ?></h3>
				<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:heading {"level":3} -->
				<h3 class="wp-block-heading"><?php echo esc_html__( 'Newquay', 'enroute' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Thu, 13 Jul – Wed, 19 Jul', 'enroute' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
