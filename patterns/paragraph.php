...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:8vw;padding-right:var(--wp--preset--spacing--60);padding-bottom:8vw;padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-text-align-left has-link-color has-large-font-size" style="font-style:italic;font-weight:400"><a href="#"><?php echo esc_html__( 'Explore Our Offers', 'enroute' ); ?></a>→</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
