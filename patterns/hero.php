		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group alignwide has-base-color has-text-color">
				...
				<div class="wp-block-group has-base-color has-text-color">
					...
					<p style="font-style:italic;font-weight:400"><?php echo esc_html__( '&ldquo;Travel changes you. As you move through this life and this world, you change things slightly, you leave marks behind, however small. And in return, life and travel leaves marks on you.&rdquo;', 'enroute' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"fontSize":"small"} -->
					<p class="has-small-font-size"><?php echo esc_html__( '—Anthony Bourdain', 'enroute' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
